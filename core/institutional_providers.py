...
def provider_capabilities():
    ...
    return pd.DataFrame([
        ...
        {'Provider': 'FMP', 'Configured': bool(cfg['FMP_API_KEY']), 'Use': 'Equity ratios, key metrics, financial health and analyst estimates within plan limits', 'Integration': 'ACTIVE / FREE TIER'},

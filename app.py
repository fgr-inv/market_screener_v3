...
market=[
    ...
    st.Page('views/market_intelligence.py',title='Market Intelligence',icon='🛰️'),
...
quant=[
    ...
    st.Page('views/model_governance.py',title='Model Governance',icon='📐'),
    st.Page('views/institutional_lab.py',title='Institutional Research Lab',icon='🏛️'),
    st.Page('views/free_data_master.py',title='Free-Data Master Coverage',icon='🧩'),
]
operations=[
